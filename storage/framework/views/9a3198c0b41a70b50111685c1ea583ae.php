<div>
    <div class="panel" style="max-width:420px;margin:2rem auto;text-align:center">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$recupero): ?>
            <h1>Area gestione</h1>
            <p>Inserisci il PIN per continuare.</p>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errore): ?>
                <div class="alert alert-danger"><?php echo e($errore); ?></div>
...
<?php /**PATH /workspace/resources/views/livewire/gestione/pin.blade.php ENDPATH**/ ?>